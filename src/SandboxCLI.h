...
inline void PrintUsage(const char* version)
{
    printf(
        ...
        "  Sandy will refuse to start if Procmon is already running (avoids disrupting other sessions).\n"
        "\n"
        "Trace mode (-t):\n"
        ...
        "  Sandy refuses to start if Procmon is already running.\n"
        "  User's Procmon FilterRules are backed up before trace and restored afterward.\n"
        "\n"
        "Crash resilience:\n"
