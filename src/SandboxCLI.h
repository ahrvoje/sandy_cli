...
inline void PrintUsage(const char* version)
{
    printf(
        ...
        "  localhost       = false                # default: false (appcontainer/lpac only, admin)\n"
        "  lan             = false                # default: false (appcontainer/lpac only)\n"
...
inline void PrintContainerToml()
{
    printf(
        ...
        "[sandbox]\n"
        "token = 'appcontainer'\n"
        "# workdir = 'inherit'            # default: inherit Sandy's current working directory\n"
        "\n"
...
inline void PrintRestrictedToml()
{
    printf(
        ...
        "# workdir   = 'inherit'           # default: Sandy's current working directory\n"
        "\n"
        "[allow.deep]                      # default: no grants (all keys default to [])\n"
        "# read    = []\n"
        "# write   = []\n"
