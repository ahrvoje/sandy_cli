...
set CONFIG=%~dp0test_audit_rt_config.toml
...
echo =====================================================================
echo  Sandy Audit Crash Test — Restricted Token Mode
echo =====================================================================
echo.
...
echo.
echo --- Phase 1: Running sandboxed process with audit (RT mode) ---
echo.
...
if exist "%AUDIT_LOG%" (
    ...
    REM Check audit log has content
...
echo =====================================================================
if %FAIL% equ 0 (
    echo  ALL TESTS PASSED: %PASS% passed, %FAIL% failed (RT mode)
) else (
    echo  SOME TESTS FAILED: %PASS% passed, %FAIL% failed (RT mode)
)
echo =====================================================================
