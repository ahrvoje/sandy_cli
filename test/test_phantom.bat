...
REM =====================================================================
REM test_phantom.bat -- Phantom test suite (persistence & observation)
REM Completely original — no overlap with existing test suites
REM =====================================================================

echo =====================================================================
echo  Phantom Test Suite -- Persistence, Observation, Cleanup Interference
...
set "CONFIG=c:\repos\sandy_cli\test\test_phantom_config.toml"
...
REM --- Check residual AppContainer SIDs ---
set "SID_FOUND=0"
...
echo =====================================================================
if %SANDY_EXIT% EQU 0 (
    echo  ALL HELD -- Sandy survived phantom attacks
) else (
