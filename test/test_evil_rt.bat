...
REM =====================================================================
REM test_evil_rt.bat — Adversarial "Break Sandy" Test Suite (RT Mode)
REM =====================================================================

set SANDY=%~dp0..\x64\Release\sandy.exe
set CONFIG=%~dp0test_evil_rt_config.toml
...
echo =====================================================================
echo  Sandy Adversarial Test Suite — Restricted Token Mode
...
REM Scripts folder
mkdir "%ROOT%\scripts"
copy /y "%~dp0test_evil_rt.py" "%ROOT%\scripts\test_evil.py" >nul
...
if !SC! EQU 0 (
    ...
    echo   [FAIL] !SC! Restricted Token SID entries remain on arena/ tree
    set /a FAIL+=1
)
...
if !SANDY_EXIT! EQU 0 if !FAIL! EQU 0 (
    echo  ALL HELD -- Sandy survived every attack (RT mode)
) else (
